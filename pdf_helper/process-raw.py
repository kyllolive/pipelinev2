...
def main():
    source_dir = f"{os.getcwd()}/raw_resolutions"  # Root directory containing all ordinance subdirectories
    target_dir = f"{os.getcwd()}/resolutions"  # Where all PDFs will be consolidated
